...
<p><img src = "https://miro.medium.com/v2/resize:fit:1400/1*iV1DdMMId9lpzoxwoY48AQ.png" alt ="expansion logo"></p>
...
* **7. Global variable**
  * [7-create_global_variable](./7-create_global_variable): Bash script that
  creates a new global variable named `Best` with value `Scool`.
